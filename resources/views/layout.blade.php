...
@section('navigation')
    ...
    <certificates-floating-bar
        :certificates="[
            {src: '{{asset('images/SDG-Wheel_Transparent_WEB.PNG')}}', alt: 'Icono de Sustainable Development Goals'},
...
@section('footer')
    <training-centers-slider
         title="Nuestros centros de formación"
         :training-centers="[
             {id: 1, link: 'https://www.fuerteventura2000.com/', src: '{{asset('images/logos_red-1.png')}}', alt: 'Logo de Fuerteventura2000 centro de formación profesional en color rojo.'},
             {id: 2, link: 'https://eheuropea.com/', src: '{{asset('images/logos_red-2.png')}}', alt: 'Logo de Escuela de Hostelería Europea en color rojo.'},
             {id: 3, link: 'https://chtcanarias.com/', src: '{{asset('images/logos_red-3.png')}}', alt: 'Logo de Centro de Hostelería y Turismo de Canarias en color rojo.'},
             {id: 4, link: 'https://fpeeuropea.com/', src: '{{asset('images/logos_red-4.png')}}', alt: 'Logo de Formación Profesional para el Empleo Europea en color rojo.'},
             {id: 5, link: 'http://e-confuer.com/', src: '{{asset('images/logos_red-5.png')}}', alt: 'Logo de Confuer, Confederación Insular de Empresarios de Fuerteventura en color rojo.'},
             {id: 6, link: 'https://esenfuer.com/', src: '{{asset('images/logos_red-6.png')}}', alt: 'Logo de Escuela Superior de Enseñanza de Fuerteventura en color rojo.'},
             {id: 7, link: 'https://www.incaem.com/', src: '{{asset('images/logos_red-7.png')}}', alt: 'Logo de INCAEM, Instituto Canario de Estudios de Empresas en color rojo.'},
             {id: 8, link: 'https://hotelescuelaelmirador.com/', src: '{{asset('images/logos_red-8.png')}}', alt: 'Logo de Hotel Escuela el Mirador en color rojo.'},
         ]"
    ></training-centers-slider>
    <footer-component
          ...
          facebook-url="https://www.facebook.com/nformarcanarias/"
