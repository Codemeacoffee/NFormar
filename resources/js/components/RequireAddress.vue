<template>
    <div class="modal fade" id="requireAddress" tabindex="-1" role="dialog" aria-labelledby="billingInfo" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center w-100" title="billingInfo"><b>Datos de facturación</b></h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="post" class="px-lg-4 px-1 pb-3" v-bind:action="url">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="billingAddress">Dirección</label>
                            <input type="text" class="form-control" id="billingAddress" name="address" v-bind:value="address" required>
                        </div>
                        <div class="form-group">
                            <label for="billingCountry">País</label>
                            <select class="form-control" name="country" id="billingCountry" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn red"><b>Aceptar</b></button>
                    </div>
                    <input v-if="forwardedTo" type="hidden" name="forwardedTo" v-bind:value="forwardedTo">
